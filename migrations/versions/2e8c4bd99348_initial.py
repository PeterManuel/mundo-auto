...
Revision ID: 2e8c4bd99348
Revises: 
Create Date: 2025-12-07 07:44:04.814135
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_shop_products_model'), 'shop_products', ['model'], unique=False)
    op.create_index(op.f('ix_shop_products_name'), 'shop_products', ['name'], unique=False)
    op.create_index(op.f('ix_shop_products_oe_number'), 'shop_products', ['oe_number'], unique=False)
    op.create_index(op.f('ix_shop_products_slug'), 'shop_products', ['slug'], unique=False)
    ...
    sa.Column('role', sa.Enum('CUSTOMER', 'LOGIST', 'ADMIN', 'SUPERADMIN', name='userrole'), nullable=False),
    ...
    sa.Column('shop_product_id', sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_shop_products_slug'), table_name='shop_products')
    op.drop_index(op.f('ix_shop_products_oe_number'), table_name='shop_products')
    op.drop_index(op.f('ix_shop_products_name'), table_name='shop_products')
    op.drop_index(op.f('ix_shop_products_model'), table_name='shop_products')
